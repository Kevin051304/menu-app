...
import 'package:menu/models/food_items/noodles_items.dart';
import 'package:shared_preferences/shared_preferences.dart';

class NoodlesState extends ChangeNotifier implements ItemState {
  @override
  ...
  Future<void> loadPersistedState() async {
    ...
    String quantitiesString = prefs.getString('noodles_quantities') ?? '[]';
    ...
    String favoritesString = prefs.getString('noodles_isFavorited') ?? '[]';
  ...
  Future<void> persistState() async {
    ...
    prefs.setString('noodles_quantities', quantitiesString);

    String favoritesString = json.encode(isFavorited);
    prefs.setString('noodles_isFavorited', favoritesString);
  }

  void getInitialInfo() {
    items = NoodlesItems.getItems();
    loadPersistedState();
  }
