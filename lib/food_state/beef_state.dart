...
import 'package:menu/models/food_items/beef_items.dart';
import 'package:shared_preferences/shared_preferences.dart';

class BeefState extends ChangeNotifier implements ItemState {
  @override
  ...
  Future<void> loadPersistedState() async {
    ...
    String quantitiesString = prefs.getString('beef_quantities') ?? '[]';
    ...
    String favoritesString = prefs.getString('beef_isFavorited') ?? '[]';
  ...
  Future<void> persistState() async {
    ...
    prefs.setString('beef_quantities', quantitiesString);

    String favoritesString = json.encode(isFavorited);
    prefs.setString('beef_isFavorited', favoritesString);
  }

  void getInitialInfo() {
    items = BeefItems.getItems();
    loadPersistedState();
  }
