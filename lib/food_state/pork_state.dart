...
import 'package:menu/models/food_items/pork_items.dart';
import 'package:shared_preferences/shared_preferences.dart';

class PorkState extends ChangeNotifier implements ItemState {
  @override
  ...
  Future<void> loadPersistedState() async {
    ...
    String quantitiesString = prefs.getString('pork_quantities') ?? '[]';
    ...
    String favoritesString = prefs.getString('pork_isFavorited') ?? '[]';
  ...
  Future<void> persistState() async {
    ...
    prefs.setString('pork_quantities', quantitiesString);

    String favoritesString = json.encode(isFavorited);
    prefs.setString('pork_isFavorited', favoritesString);
  }

  void getInitialInfo() {
    items = PorkItems.getItems();
    loadPersistedState();
  }
