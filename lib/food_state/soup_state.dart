...
import 'package:menu/models/food_items/soup_items.dart';
import 'package:shared_preferences/shared_preferences.dart';

class SoupState extends ChangeNotifier implements ItemState {
  @override
  ...
  Future<void> loadPersistedState() async {
    ...
    String quantitiesString = prefs.getString('soup_quantities') ?? '[]';
    ...
    String favoritesString = prefs.getString('soup_isFavorited') ?? '[]';
  ...
  Future<void> persistState() async {
    ...
    prefs.setString('soup_quantities', quantitiesString);

    String favoritesString = json.encode(isFavorited);
    prefs.setString('soup_isFavorited', favoritesString);
  }

  void getInitialInfo() {
    items = SoupItems.getItems();
    loadPersistedState();
  }
